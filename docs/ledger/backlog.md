...
| GL-005 | Dashboard PnL calculations and analytics accuracy | todo | Audit all math logic; acceptance: recomputed-from-journal values match displayed values exactly. |
