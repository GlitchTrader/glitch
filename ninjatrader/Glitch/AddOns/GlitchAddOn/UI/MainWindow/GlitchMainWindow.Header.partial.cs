...
namespace Glitch.UI
{
    public partial class GlitchMainWindow
    {
        private UIElement CreateHeaderBarImpl()
        {
            ...
            _headerMetricBoxesPanel.Children.Add(CreateHeaderMetricDataBox(_headerRootGrid, "header.metric.fleet_upnl", "Session PnL", out _totalPnlValueText, new Thickness(0)));
