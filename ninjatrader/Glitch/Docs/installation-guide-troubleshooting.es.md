# Guía de instalación, actualización y solución de problemas de Glitch v0.0.2.0
...
Glitch v0.0.2.0 tiene dos paquetes completos y alternativos:
...
Los únicos jobs compatibles con v0.0.2.0 son:
