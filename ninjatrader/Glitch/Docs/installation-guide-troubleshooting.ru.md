# Руководство по установке, обновлению и устранению неполадок Glitch v0.0.2.0
...
Glitch v0.0.2.0 выпускается в двух полных взаимоисключающих пакетах:
...
- установлен `Glitch_AI_v0.0.2.0.zip`;
...
В v0.0.2.0 поддерживаются ровно два jobs:
