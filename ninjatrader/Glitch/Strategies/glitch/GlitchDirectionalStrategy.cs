...
{
    public class GlitchDirectionalStrategy : Strategy
    {
        private const int MinBarsForSignal = 30;
        private const int ZLookback = 30;
        private const string StrategyProfileVersion = "v2.2-gated";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name = "GlitchDirectionalStrategy";
                ...
                TelemetryFilePrefix = "GlitchDirectional";
