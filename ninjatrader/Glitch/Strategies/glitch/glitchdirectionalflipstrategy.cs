// GlitchDirectionalFlipStrategy.cs
...
{
    public class GlitchDirectionalFlipStrategy : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "GlitchDirectionalFlipStrategy";
                ...
                CancelPendingOnOppositeSignal = true;

                // Visuals (no impact on trade logic)
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (BarsInProgress == 0)
            {
                ...
                else
                {
                    ...
                    {
                        // If signal has flipped against pending direction, cancel stale pending entry.
                        ...
                        if (!pendingEntry)
                        {
                            // Pending was invalidated above; allow current bar to process new flip logic.
                        }
                        else
                        {
        ...
        [NinjaScriptProperty]
        [Range(50, 2000)]
        [Display(Name = "Daily Profit Target ($)", Description = "Stop trading after reaching this profit", Order = 13, GroupName = "3. Filters")]
        public double DailyProfitTarget { get; set; }

        [NinjaScriptProperty]
        [Range(50, 2000)]
        [Display(Name = "Daily Loss Limit ($)", Description = "Stop trading after losing this amount", Order = 14, GroupName = "3. Filters")]
