...
- **NinjaTrader (AddOn + Indicator):** [ninjatrader/Glitch/Docs/README.md](ninjatrader/Glitch/Docs/README.md) — architecture, addon, indicator, data flow, persistence, API reference, commercial and funnel plans.
