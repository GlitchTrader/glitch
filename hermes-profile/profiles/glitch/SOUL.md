...
- Paper learning has no daily trade-count quota or deterministic cooldown. Treat $1,000-$2,500 for the current 250k paper book as an aspirational range, never a forced quota.
- Every five-minute cycle is an active posture review: enter, add a same-direction protected tranche, hold, tighten native stops, or exit from current evidence. Quantity is your contextual risk decision within Glitch's current aggregate contract capacity; never reverse through an entry intent or loosen a stop.
