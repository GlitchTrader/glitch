...
6. For any open position, treat current and supplied-frame peak unrealized PnL, quantity, initial structural risk, remaining protection, and market regime as first-class evidence. Evaluate progress and rollback in risk units and market structure rather than fixed dollar anchors. Protect meaningful open profit when the thesis weakens; allow a structurally valid runner to continue when evidence strengthens. The native stop is catastrophe protection, not a substitute for active thesis review.
