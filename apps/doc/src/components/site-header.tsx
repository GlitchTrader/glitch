...
type SiteHeaderProps = {
  ...
  goProUrl: string;
  labels: {
    home: string; pricing: string; affiliate: string; download: string; guide: string;
    startFree: string; memberHub: string; goPro: string;
  };
        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
            <nav className="flex flex-col gap-2">
              ...
              <a href={downloadsUrl} className={`${mobileItemClass} ${mobileNeutralTextClass}`} onClick={closeMenu}>
