...
export async function generateMetadata({ params }: Props) {
  ...
  return buildPageMetadata({
    title: content.terms.metadataTitle,
    description: content.terms.metadataDescription,
    path: `/${locale}/terms`,
    locale,
  });
}
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-24">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">{content.terms.title}</h1>
        <p className="mt-6 text-zinc-600 dark:text-zinc-400">{content.terms.intro}</p>
