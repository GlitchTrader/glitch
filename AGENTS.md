...
- Durable current work lives only in `docs/ledger/ledger.json` on `main`. From this branch, read it with `git show origin/main:docs/ledger/ledger.json` and route lifecycle changes through the Glitch PM/default branch.
